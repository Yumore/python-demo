            ...
            while True:
                ...
                if 选项 == '检测基础字段':
                    ...
                    if 批次号列表:
                        ...
                        ws.title = '理算结果'
                        if 单位 == '公交':
                            title = ['姓名', '性别', '身份证号', '案件号', '门诊自付一', '门诊起付金额', '门诊超封顶金额', '门诊自付二', '门诊自费', '住院自付一', '住院起付金额', '住院超封顶金额', '住院自付二', '住院自费', '门特自付一', '门特起付金额', '门特超封顶金额', '门特自付二', '门特自费',
                                     '门诊理算', '住院理算', '理算结果', '年份', '单位']

                        elif 单位 == '地铁':
                            title = ['姓名', '身份证号', '案件号', '门诊自付一', '门诊起付金额', '门诊超封顶金额', '门诊自付二', '门诊自费', '住院自付一', '住院起付金额', '住院超封顶金额', '住院自付二', '住院自费', '门特自付一', '门特起付金额', '门特超封顶金额', '门特自付二', '门特自费', '门诊理算',
                                     '住院理算', '理算结果', '年份']
